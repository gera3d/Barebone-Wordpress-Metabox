=== Plugin Name ===
Contributors: Gera Yeremin
Donate link: https://github.com/gera3d
Tags: wordpress, metabox,
...
Add you do is add information in the metabox that appears in the post.

If you want to change the plug to do something else open barebox-metabox.php I breakdown the code base step by step.
